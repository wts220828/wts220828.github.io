...
document.write("<div style=\"position:fixed;bottom: 0px;right: 100px;opacity: 0.33;font-family: UbuntuMono;font-size: 10px;\"> <pre style=\"color: black;\" id=\"debuginfox\"><\/pre> <\/div>");
...
document.write("        var myWindow = window.open('https:\/\/www.digicert.com\/help\/?host=wts220828.github.io', 'VerifyDigiCert', 'width=720,height=500');");
document.write("    };");
document.write("    function getIP(json) {");
document.write("        document.getElementById(\"debuginfox\").innerHTML =  \"Last Sync:\"+Date()+\" IP:\"+json.ip+\"\n\"+\"UA:\"+window.navigator.userAgent;");
document.write("    }");
document.write("<\/script>");
